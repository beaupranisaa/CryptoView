...
def get_all_binance(get_what, symbol, kline_size, save = False):
    ...
    klines = getattr(binance_client, get_what)(symbol, kline_size, oldest_point.strftime("%d %b %Y %H:%M:%S"), newest_point.strftime("%d %b %Y %H:%M:%S"))
...
if __name__ == "__main__":
    ...
    get_all_binance(get_what, "BTCUSDT", '1h', save=True)
